...
#st.cache
def get_model():
    RIDNet = tf.keras.models.load_model('RIDNet.h5', compile=False)  # Do not compile the model here
    # Recompile the model with a proper loss function and optimizer
    RIDNet.compile(optimizer='adam', loss='mse')  # Replace 'mse' with your loss function if different
    return RIDNet
